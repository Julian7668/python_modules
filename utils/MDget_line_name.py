...
def _validate_pattern(
    ...
    # Importación local para evitar ciclo mortal
    from utils import finalized  # pylint: disable=import-outside-toplevel

    finalized("La expresión regular no hizo el match debido", False)
...
def get_line_name(
    ...
    if frame_info.code_context is None:
        ...
        finalized("La línea de código está vacía", False)
